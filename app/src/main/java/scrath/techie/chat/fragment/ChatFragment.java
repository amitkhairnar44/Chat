...
import scrath.techie.chat.view.LoginActivity;
import scrath.techie.chat.R;
import scrath.techie.chat.adapter.ChatFirebaseAdapter;
import scrath.techie.chat.adapter.ClickListenerChatFirebase;
import scrath.techie.chat.model.ChatModel;
import scrath.techie.chat.model.FileModel;
import scrath.techie.chat.model.MapModel;
import scrath.techie.chat.model.UserModel;
import scrath.techie.chat.util.Util;
import scrath.techie.chat.view.FullScreenImageActivity;
...
public class ChatFragment extends Fragment implements GoogleApiClient.OnConnectionFailedListener,View.OnClickListener, ClickListenerChatFirebase{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this scrath.techie.chat.fragment
        View view = inflater.inflate(R.layout.fragment_chat, container, false);
        if (!Util.verifyConnection(this.getContext())){
            Util.initToast(this.getContext(),"No internet connection!!!");
            //finish();
        }else{
            ...
            emojIcon = new EmojIconActions(this.getContext(),contentRoot,edMessage,btEmoji);
            emojIcon.ShowEmojIcon();
            rvListMessage = (RecyclerView)view.findViewById(R.id.messageRecyclerView);
            mLinearLayoutManager = new LinearLayoutManager(ChatFragment.super.getContext());
...
//    }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        Util.initToast(this.getContext(),"Google Play Services error.");
    }
    ...
    public void clickImageChat(View view, int position,String nameUser,String urlPhotoUser,String urlPhotoClick) {
        Intent intent = new Intent(this.getContext(),FullScreenImageActivity.class);
    ...
    /**
     * Read collections chat model Firebase
     */
